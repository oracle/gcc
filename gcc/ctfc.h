...
typedef struct GTY (()) ctf_func_arg
{
  ...
  unsigned int farg_name_offset;  /* Offset of the name in str table.  */
...
extern const char * ctf_add_string (ctf_container_ref ctfc, const char * name,
...
extern void ctf_add_cuname (ctf_container_ref ctfc, const char * filename);
...
extern void ctf_debug_finalize (const char *filename, bool btf);
